        ...
        <div class="container">
            <div class="main">
                ...
                <slot name="home-hero-info">
                    <h1 class="heading">
                        <span v-if="name" v-html="name" class="name clip animate-name"></span>
                        <span v-if="text" v-html="text" class="text animate-text"></span>
                    </h1>
                    <p v-if="tagline" v-html="tagline" class="tagline animate-tagline"></p>
                </slot>
                <slot name="home-hero-info-after"/>

                <div v-if="actions" class="actions animate-actions">
                    <div v-for="(action, index) in actions" :key="action.link" class="action"
...
.animate-image {
    animation: fadeInRotate 1s cubic-bezier(0.16, 1, 0.3, 1) 0.4s backwards;
}

.animate-image-bg {
    animation: pulseGlow 1.2s cubic-bezier(0.16, 1, 0.3, 1) 0.2s backwards;
}
...
.KikoHero.has-image .name,
.KikoHero.has-image .text {
    margin: 0 auto;
}
