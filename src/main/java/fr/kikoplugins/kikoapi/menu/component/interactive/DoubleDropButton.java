...
public class DoubleDropButton extends MenuComponent {
    ...
    private DoubleDropButton(
            ...
            Consumer<KikoInventoryClickEvent> onClick,
            Consumer<KikoInventoryClickEvent> onLeftClick, Consumer<KikoInventoryClickEvent> onRightClick,
            Consumer<KikoInventoryClickEvent> onShiftLeftClick, Consumer<KikoInventoryClickEvent> onShiftRightClick,
            Consumer<KikoInventoryClickEvent> onDoubleDrop,
            Sound sound,
     ...
     */
    @Contract(value = "_ -> this", mutates = "this")
    public DoubleDropButton onDoubleDrop(Consumer<KikoInventoryClickEvent> onDoubleDrop) {
    ...
    public static class Builder extends MenuComponent.Builder<Builder> {
         ...
         */
        @Contract(value = "_ -> this", mutates = "this")
        public Builder onDoubleDrop(Consumer<KikoInventoryClickEvent> onDoubleDrop) {
            Preconditions.checkNotNull(onDoubleDrop, "onDoubleDrop cannot be null");
