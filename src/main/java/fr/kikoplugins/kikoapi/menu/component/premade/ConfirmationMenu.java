package fr.kikoplugins.kikoapi.menu.component.premade;
...
public class ConfirmationMenu extends Menu {
    ...
    private final Consumer<KikoInventoryClickEvent> yesConsumer, noConsumer;
    ...
    public ConfirmationMenu(
            ...
            Consumer<KikoInventoryClickEvent> yesConsumer, Consumer<KikoInventoryClickEvent> noConsumer
    ) {
        super(player);
